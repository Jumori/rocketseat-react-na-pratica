...
export function Header() {
  const svgURI = `data:image/svg+xml;utf8,${encodeURIComponent(minidenticon(crypto.randomUUID(), Math.random() * 100, Math.random() * 100))}`
    ...
    <div className="max-w-[1200px] mx-auto flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        <div className="flex flex-col items-end gap-0.5">
          ...
          <span className="text-xs text-zinc-400">johndoe@email.com</span>
        </div>
        <img src={svgURI} className="size-8 rounded-full" alt="User avatar" />
